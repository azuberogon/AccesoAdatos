...
public class Main {
    ...
    public static void main (String[] args) {
        System.out.println("-----------------------------------------");
        System.out.println("-----------------------------------------");
        System.out.println("---------- UT2 A7 - App completa --------");
        System.out.println("-----------------------------------------");
        System.out.println("-----------------------------------------");
    ...
    private static void buscarDestinatario(){
        System.out.print("Introduzca el texto que desea buscar en destinatario: ");
        String destinatario = sc.nextLine();
        List<Factura> facturas = facturaService.obtenerPorDestinatario(destinatario);
        if (facturas.isEmpty()) {
            System.out.println("No existe ninguna factura cuyo destinatario coincida con lo introducido");
            return;
        }

        System.out.println("Se han encontrado las siguientes facturas: ");
        for (Factura factura : facturas)
            System.out.println(factura);
    }
    ...
    private static void anadirFactura() {
        ...
        try {
            ...
            logger.error("Error al crear la factura para insertar: ", e.fillInStackTrace());
            return;
        }
