...
import UT4_A4_CRUD.service.ClienteService;
...
public class ClienteController {
    ...
    public String cliente(
        ...
        @RequestParam(name = "apelldio1", required = false ) String apellido1,
        @RequestParam(name = "apelldio2", required = false ) String apellido2,
